...
val_dataset = os.path.join(args.data_dir, 'data/Haze_1k/thick/test/input')
...
output_dir=os.path.join(args.model_save_dir,'thick(danci)_results')
...
try:
    MyEnsembleNet.load_state_dict(torch.load( 'train_result/best_epoch.pkl'))
    print('--- weight loaded ---')
except:
